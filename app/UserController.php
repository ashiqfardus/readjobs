...
class UserController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware(['auth','TwoFA'], ['except' => ['showApplicantProfileEducation', 'showApplicantProfileProjects', 'showApplicantProfileExperience', 'showApplicantProfileSkills', 'showApplicantProfileLanguages']]);
    }
    ...
    public function myProfile()
    {
        ...
        $jobCertificationIds = ProfileCertification::where('user_id', '=', Auth::user()->id)->pluck('certification_id')->toArray();;
    ...
    public function updateMyProfile(UserFrontFormRequest $request)
    {
        ...
        if ($request->career_level_id==23){
            ...
            $this->deleteUserCertifications(Auth::user()->id);
        }
