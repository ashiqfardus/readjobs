        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li> <span>Company Upload</span> </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title">Upload Companies</h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
                ...
                <div class="col-md-12">
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo"> <i class="icon-settings font-red-sunglo"></i> <span class="caption-subject bold uppercase">Company upload form</span> </div>
                        </div>
                        <div class="portlet-body form">
                            <form method="POST" action="{{route('bulk.company.store')}}" accept-charset="UTF-8" class="form" enctype="multipart/form-data">
                                @csrf
